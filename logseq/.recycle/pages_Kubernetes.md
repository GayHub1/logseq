- ```
  ...
  _          collapsed:: true
              ...
              - cloud-controller
                collapsed:: true
                  - 与云服务商交互
              - [官网详情](_https://kubernetes.io/zh-cn/docs/concepts/overview/components/_)
  - _## __安装 __Kubernetes __集群
  _  collapsed:: true
      - > 非云平台均需要Docker环境
      - _### minikube
  _      id:: 62c59c8e-19e7-4228-9fb8-4282c29971b9
        collapsed:: true
          - 只是一个 K8S 集群模拟器，只有一个节点的集群，只为测试用，master 和 worker 都在一起
          - [安装方法](_https://minikube.sigs.k8s.io/docs/start/_)
      - _### __云平台 __Kubernetes
  _      collapsed:: true
          - 可视化搭建，只需简单几步就可以创建好一个集群。
            优点：安装简单，生态齐全，负载均衡器、存储等都给你配套好，简单操作就搞定
          - [腾讯云容器服务 TKE](_https://cloud.tencent.com/product/tke_) （控制台搜索容器）
            登录阿里云控制台 - 产品搜索 Kubernetes
      - _### __裸机安装（__Bare Metal__）
  _      collapsed:: true
          - 缺点
            collapsed:: true
	...
	- 用 kubeadm 初始化集群（仅在主节点跑)
	  collapsed:: true
		- ```sh
		                ...
		                ```
		- [kubeadm init  做了啥](_https://kubernetes.io/docs/reference/setup-tools/kubeadm/kubeadm-init/_)
	- 把工作节点加入集群（只在工作节点跑）
	  collapsed:: true
		- ```sh
